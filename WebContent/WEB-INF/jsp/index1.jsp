		...
		<div class="header-content">
			<div id="sel">
				<form>
					...
					<button type="submit" class="btn btn-default" onclick="callme()">Book a
						Service</button>
				</form>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 text-center">
					<div class="service-box">
						<a href="#" style="color: black; text-decoration: none" onclick="callme()"><img
				...
				<div class="col-lg-3 col-md-6 text-center">
					<div class="service-box">
						<a href="#"
							style="color: black; text-decoration: none" onclick="callme()"><img
				...
				<div class="col-lg-3 col-md-6 text-center">
					<div class="service-box">
						<a href="#" style="color: black; text-decoration: none" onclick="callme()">
				...
				<div class="col-lg-3 col-md-6 text-center">
					<div class="service-box">
						<a href="#"
							style="color: black; text-decoration: none" onclick="callme()">
